        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-8 mx-auto my-5 ml-1 mr-1">
                    ...
                    <form class="row g-3" id="contraForm" method="post">
                        <div class="col-md-12">
                            <label for="correo0" class="form-label">Introduce tu correo para cambiar tu contraseña</label>
                            <input type="email" class="form-control" id="correo" name="correo0" placeholder="Ingrese su correo" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" oninput="changeClass()" required>
                            <div class="invalid-feedback">Ingrese un correo electrónico válido.</div>
                        </div>
                        <div class="col-md-12">
                            <label for="hora" class="form-label">Nueva contraseña</label>
                            <input type="password" class="form-control" id="contraseña" name="contraseña0" placeholder="Ingrese la nueva contraseña" pattern=".{8,}" title="Debe tener al menos 8 caracteres" oninput="changeClass()" required>
                            <div class="invalid-feedback">La nueva contraseña debe contener al menos 8 letras o símbolos.</div>
                        </div>
                        
                        <div class="col-5"></div>
                        <div class="col-2 ms-2 ms-sm-auto"><button class="btn btn-primary btn-con-padding" id="submitForm" type="submit">Cambiar Contraseña</button></div>
                        <div class="col-5"></div>
...
<script> <?php require_once("Public/static/js/recuperar_contra.js"); ?> <!-- script que maneja el cambio de contraseña  </script>
</html>