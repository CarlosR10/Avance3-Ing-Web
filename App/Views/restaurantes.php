...
<body>
    ...
    <section id="searchbar">
            <div class="card mx-auto bsearch">
                <div class="card-body ">
                    <h2 class="card-title text-center mb-4">Restaurantes</h2>

                    <form id="busquedaForm" action="#" method="post">
                        <div class="input-group">
                            <input id="busqueda" type="text" class="form-control" placeholder="Buscar un Leños & Carbón..." required>
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" >Buscar <i class="bi bi-search"></i></button>
                                <a id="filtro" href="<?php echo LOCAL_HOST; ?>/restaurant/search" class="btn btn-secondary"><i class="bi bi-list-ol"></i> Todo</a>
                            </div>
                        </div>
                    </form>
    ...
    <!-- echo $parameters['TRUE'] ? $parameters['rest'] : "Leños & Carbón" -->
    <!-- Scroll de restaurantes -->
    <section id="scrollpane">
        <div id="restaurant-list" class="vertical-menu card-columns mt-3 ms-4 me-5 ms-md-5 ps-md-3 rounded-1"></div>
    </section>
    ...
    <div class="container d-flex justify-content-center" >
        <a type="button" href="<?php echo LOCAL_HOST; ?>/preorder/new" class="btn btn-primary mx-auto mt-3" style="height: fit-content">Nueva Reserva</a>
    </div>
...
<script> <?php require_once("Public/static/js/filtrar_restaurante.js"); ?> <!-- script que realiza la busqueda por filtros -->  </script>
<script> <?php require_once("Public/static/js/buscar_restaurante.js"); ?> <!-- script que lee los datos del formulario y redirecciona  </script>
</html>